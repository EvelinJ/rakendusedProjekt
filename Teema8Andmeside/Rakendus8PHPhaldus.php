...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_POST['kustuta'])) { // kontrollime kas vormis oli väli nimega "kustuta"
        ...
        //salvestame andmebaasi uue andmebaasi, mis on ilma kustutatud elemendita
	...
	//kui on get päring, siis andmebaasi ei töötle ja haldus lehele minnes avaks kohe hetkeseisuga tabeli
